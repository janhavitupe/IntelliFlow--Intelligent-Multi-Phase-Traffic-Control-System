"""Helper: write config/rl.py with UTF8 no-BOM (reliable on this project)."""
import io
...
with io.open("D:/traffic/config/rl.py", "w", encoding="utf-8", newline="\n") as f:
    f.write(content)

print("config/rl.py written, bytes:", len(content.encode("utf-8")))
